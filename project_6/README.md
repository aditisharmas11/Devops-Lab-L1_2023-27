...
This project demonstrates application scalability using Kubernetes Horizontal Pod Autoscaling (HPA). It deploys SiddhantOps, exposes it through a Service, generates traffic, and shows Kubernetes increasing or decreasing the number of Pods based on CPU usage.
