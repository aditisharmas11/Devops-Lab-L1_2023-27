...
| **GitFlow demo repo** | [branching-demo-app](https://github.com/arshansari2880-alt/branching-demo-app) |
...
| [Project 2 – Angular in Docker](./Project2-Angular-Docker/README.md) | Angular CLI + Compose for dev (`4200`) and prod (`4201`) | Done |
| [Project 2 extra – React in Docker](./Project2-React-Docker/README.md) | Extra Vite React + Nginx on `3080` | Done |
| [Project 3 – Branching model](./Project3-Branching-Development-Model/README.md) | GitFlow: feature / release / hotfix | Done |
...
| [Project 5 – Spring Boot + image scan](./Project5-Spring-Boot-Docker-Scan/README.md) | Retail API in Docker, Trivy HIGH/CRITICAL scan | Done |
| [Project 6 – K8s HPA](./Project6-Kubernetes-Autoscaling/README.md) | Kind cluster + social-feed autoscaling | Done |
| [Project 7 – Mongo + Mongo Express](./Project7-Mongo-MongoExpress/README.md) | Secret, ConfigMap, Deployments, Services | Done |
| [Project 8 – Four microservices](./Project8-Four-Microservices/README.md) | Gateway + user/product/order on K8s | Done |
| [Project 9 – Apache2 on K8s](./Project9-Apache-K8s/README.md) | httpd Deployment, host access via NodePort | Done |
...
├── Project2-Angular-Docker/
├── Project2-React-Docker/
├── Project3-Branching-Development-Model/
├── Project4-Distributed-Jenkins-Maven/
├── Project5-Spring-Boot-Docker-Scan/
├── Project6-Kubernetes-Autoscaling/
├── Project7-Mongo-MongoExpress/
├── Project8-Four-Microservices/
├── Project9-Apache-K8s/
├── kind-cluster.yaml
└── metrics-server.yaml
```
...
# Angular production (host 4201 -> Nginx 80)
cd ..\Project2-Angular-Docker
docker compose up --build -d

# Angular development (host 4200)
...
# Spring Boot retail API (host 8091)
cd ..\Project5-Spring-Boot-Docker-Scan
docker compose up --build -d

# Kubernetes (kind cluster devops-lab, NodePorts 30080-30083)
