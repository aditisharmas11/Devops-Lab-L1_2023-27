...
public class PortfolioServiceTest {
    ...
    public void testResumePopulation() {
        ...
        assertEquals("Omkar Kadam", resume.getContact().getName());
        assertEquals("kadamomkarpc@gmail.com", resume.getContact().getEmail());
    ...
    public void testEmailValidation() {
        assertTrue(service.isValidEmail("kadamomkarpc@gmail.com"));
        assertTrue(service.isValidEmail("omkar.kadam@sitpune.edu.in"));
        assertFalse(service.isValidEmail("invalid-email"));
        assertFalse(service.isValidEmail("omkar@"));
